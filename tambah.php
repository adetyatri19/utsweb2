...
<body>
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg text-uppercase" style="background-color: #008B8B">
        <div class="container">
    ...
    <div class="container">
        <div class="row my-2">
          <div class="col-md">
              <h3 class="fw-bold text-uppercase"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Data HP</h3>
            </div>
            <hr>
  <section class="row">
    <div class="col-md-6 offset-md-3 align-self-center"> 
      ...
      <form method="POST">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="inputMerek" name="merek" placeholder="Masukan Merek HP">
        </div>
        <div class="mb-3">
          <label for="inputTipe" class="form-label">Tipe</label>
          <input type="text" class="form-control" id="inputTipe" name="tipe" placeholder="Masukan Tipe HP">
        </div>
        <div class="mb-3">
          <label for="inputTahun" class="form-label">Tahun Produksi</label>
          <input type="text" class="form-control" id="inputTahun" name="tahun" placeholder="Masukan Tahun Produksi HP">
        </div>
  ...
  <!-- Footer -->
    <div class="container-fluid" style="margin-top: 30px;">
        <div class="row text-white"style="background-color: #008B8B">
    ...
    <footer class=" text-white text-center" style="padding: 5px;background-color: #008B8B">
        <p>Created with <i class="bi bi-suit-heart-fill" style="color: red;"></i> by <u style="color: #fff;">Ade tri</u></p>
    </footer>
    <!-- Close Footer -->
    <!-- Bootstrap -->
